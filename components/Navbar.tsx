    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-border">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 h-16">
        ...
        <div className="flex items-center gap-2">
          {/* WA button: hidden on mobile, visible on md+ */}
          <a
            ...
            style={{ display: "none" }}
            className="md:inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold px-4 py-2.5 rounded-lg shadow-sm transition-colors text-sm"
          >
