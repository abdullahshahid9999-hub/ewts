      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 h-16">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-lg shadow-sm transition-colors text-sm w-9 h-9 md:w-auto md:h-auto md:px-4 md:py-2.5"
