    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-border">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 h-16">
        ...
        <div className="flex items-center gap-2">
          {/* WA: icon-only on mobile (<md), full button on md+ */}
          <a
            href={waLink("Assalam o Alaikum! I am interested in your travel services. Please share details.")}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-lg shadow-sm transition-colors text-sm"
            style={{ width: "36px", height: "36px", flexShrink: 0 }}
            aria-label="WhatsApp Us"
            onMouseEnter={(e) => { const el = e.currentTarget; el.style.background = "#20bd5a"; }}
            onMouseLeave={(e) => { const el = e.currentTarget; el.style.background = "#25D366"; }}
          >
