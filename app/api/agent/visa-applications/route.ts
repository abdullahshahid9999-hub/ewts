...
export async function GET(req: NextRequest) {
  ...
  const applications = await prisma.visaApplication.findMany({
    ...
    include: {
      ...
      applicants: { select: { id: true, fullName: true, ageGroup: true, passportNumber: true, passportExpiry: true, dob: true, dateOfIssue: true, issuingCountry: true, nationality: true, applicantCategory: true, documents: { select: { id: true, fileUrl: true, fileName: true } } } },
    },
  });
