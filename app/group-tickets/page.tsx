    ...
    <>
      ...
      <section className="bg-[var(--lp-ink)] text-white text-center px-6 pt-16 pb-14">
        ...
        <h1 className="font-display text-4xl md:text-5xl font-semibold mb-4">
          Group Air <span className="italic text-[var(--lp-brass)]">Tickets</span>
        </h1>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-10 text-center">
        <p className="text-[var(--lp-brass)] font-semibold tracking-widest text-xs uppercase mb-3">Select Destination</p>
        <h2 className="font-display text-2xl font-semibold mb-2">
          Choose Your <span className="italic text-[var(--lp-brass)]">Category</span>
        </h2>
        ...
        <h3 className="font-display text-xl font-semibold mb-6">
          Available <span className="italic text-[var(--lp-brass)]">Departures</span>
        </h3>
      </section>
